...
export const Model = ({
  ...
  useEffect(() => {
    ...
    // Lighting
    const ambientLight = new AmbientLight(0xffffff, 30.2);
    const keyLight = new DirectionalLight(0xffffff, 40.1);
    const fillLight = new DirectionalLight(0xffffff, 10.8);

    fillLight.position.set(-6, 2, 2);
    keyLight.position.set(0.5, 0, 10);
