...
export function ProjectPageLeftHeader({
  ...
  return (
    <Section className={classes(styles.leftHeader, className)} as="section">
      <div
...
export const ProjectPageSection = forwardRef(
  (
    ...
    >
      ...
      <Section className={styles.sectionLeftInner} data-padding={padding}>
        {children}
      </Section>
    </section>
  )
...
export const ProjectPageText = ({ className, ...rest }) => (
  <Text className={classes(styles.sectionProjectText, className)} size="l" as="p" {...rest} />
);
...
export const HonorTextRow = ({
  ...
  <div
    className={classes(styles.textRowHM, className)}
    data-center={center}
    data-stretch={stretch}
    data-center-mobile={centerMobile}
    data-no-margin={noMargin}
